...
group :system_tests do
  ...
  gem 'beaker-module_install_helper', :git => 'https://github.com/wilson208/beaker-module_install_helper.git', :branch => 'fix-beaker-forge-api-not-specified-error', :require => false
